...
const siteData = {
  ...
  hero: {
    ...
    backgroundImages: [
      { url: "https://images.unsplash.com/photo-1504222490345-c075b6008014?w=1920&q=85", alt: "Dynamic hero image showcasing the business" },
      { url: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=1920&q=85", alt: "Professional work environment" },
      { url: "https://images.unsplash.com/photo-1504222490345-c075b6008014?w=1920&q=85", alt: "Quality results and satisfied clients" },
    ],
  },
  ...
  services: {
    ...
    items: [
      { title: "Freight Transport", slug: "freight-transport", desc: "Reliable road freight across Zimbabwe and into neighbouring countries. Temperature-controlled and general cargo options.", features: ["Full Truckload", "Partial Load", "Temperature Control", "Flatbed", "Hazardous Goods", "Tracking"], image: "https://images.unsplash.com/photo-1504222490345-c075b6008014?w=800&q=80" },
      { title: "Express Delivery", slug: "express-delivery", desc: "Same-day and next-day delivery for time-sensitive shipments within Harare and major Zimbabwean cities.", features: ["Same-Day", "Next-Day", "Timed Delivery", "Signature Required", "Insurance", "Tracking"], image: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=800&q=80" },
      { title: "Warehousing", slug: "warehousing", desc: "Secure, modern warehousing facilities with inventory management systems and flexible storage terms.", features: ["Secure Storage", "Inventory Management", "Pick & Pack", "Cross-Docking", "Climate Control", "24/7 Access"], image: "https://images.unsplash.com/photo-1504222490345-c075b6008014?w=800&q=80" },
      { title: "Cross-Border", slug: "cross-border", desc: "Seamless cross-border logistics to South Africa, Botswana, Mozambique, and Zambia with full customs clearance.", features: ["Customs Clearance", "Documentation", "SA Routes", "Botswana Routes", "Mozambique", "Zambia"], image: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=800&q=80" },
  ...
  projects: {
    ...
    items: [
      { title: "The Signature Project", slug: "the-signature-project", category: "Freight", location: "Harare, Zimbabwe", desc: "A showcase of our commitment to quality and client satisfaction.", client: "Private Client", services: ["Freight Transport", "Express Delivery"], image: "https://images.unsplash.com/photo-1504222490345-c075b6008014?w=800&q=80", images: ["https://images.unsplash.com/photo-1504222490345-c075b6008014?w=800&q=80", "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=800&q=80"] },
      { title: "Heritage Collection", slug: "heritage-collection", category: "Express", location: "Harare, Zimbabwe", desc: "A showcase of our commitment to quality and client satisfaction.", client: "Private Client", services: ["Freight Transport", "Express Delivery"], image: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=800&q=80", images: ["https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=800&q=80", "https://images.unsplash.com/photo-1504222490345-c075b6008014?w=800&q=80"] },
  ...
  homeCta: {
    ...
    backgroundImage: "https://images.unsplash.com/photo-1504222490345-c075b6008014?w=1920&q=85",
  },
