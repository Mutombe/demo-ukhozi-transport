    ...
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      >
        ...
        <div className="overflow-hidden">
          {['WHERE CARGO ', 'MOVES', ' WITH PURPOSE.'].map((line, i) => (
            <motion.div
              key={line}
              initial={{ y: '110%' }}
              animate={{ y: 0 }}
      ...
      <div className="hidden lg:flex absolute right-8 bottom-12 z-20">
        ...
        >
          Ukhozi Transport &mdash; Harare, Zimbabwe
        </span>
      </div>
    </section>
  );
...
function MarqueeTicker() {
  const items = ['FREIGHT', 'EXPRESS DELIVERY', 'WAREHOUSING', 'CROSS-BORDER', 'FLEET MANAGEMENT', 'LAST MILE'];
...
function ServicesGrid() {
  ...
  const serviceImages = ['https://images.unsplash.com/photo-1570480548578-3d49ca005e67?w=800&q=80', 'https://images.unsplash.com/photo-1494412574643-ff11b0a5eb95?w=800&q=80', 'https://images.unsplash.com/photo-1570480548578-3d49ca005e67?w=800&q=80', 'https://images.unsplash.com/photo-1494412574643-ff11b0a5eb95?w=800&q=80', 'https://images.unsplash.com/photo-1570480548578-3d49ca005e67?w=800&q=80', 'https://images.unsplash.com/photo-1494412574643-ff11b0a5eb95?w=800&q=80'];
...
function WhyChooseUs() {
  ...
  const points = [
    { title: 'GPS-Tracked Fleet', desc: 'Real-time visibility on every shipment so you always know where your cargo is.' },
    { title: '99% On-Time Rate', desc: 'Reliability is not a goal, it is our standard. We deliver when we say we will.' },
    { title: 'Cross-Border Expertise', desc: 'Seamless customs clearance and documentation for shipments across Southern Africa.' },
    { title: 'Professional Drivers', desc: 'Licensed, trained, and committed to the safe handling of every consignment.' }
  ];
    ...
    <section ref={ref} className="bg-navy-900 py-24 sm:py-32 lg:py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            <img
              src="https://images.unsplash.com/photo-1494412574643-ff11b0a5eb95?w=800&q=80"
              alt="Ukhozi Transport quality work"
              className="w-full aspect-[4/5] object-cover object-center"
              loading="lazy"
            />
          ...
          >
            ...
            <h2 className="font-heading text-white leading-[0.95] italic mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>
              Why Choose <span className="text-gold-500">Ukhozi</span>
            </h2>
